...
recent-merges feed, pulled via gh CLI. Runs on a schedule (every 15 min)
via .github/workflows/profile-stats.yml -- gh search prs is a cheap call,
so there is no need to gate it behind a notification pre-check.
"""
